...
\usepackage[hyphens]{url}
  ...
  \journal{Energy Policy} % Sets Journal name
...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Some commenst on the interstection of gas and electricity markets, eastern Australia, 2020-2020},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{Some commenst on the interstection of gas and electricity markets,
eastern Australia, 2020-2020}
    \author[University of Melbourne]{Mike Sandiford\corref{1}}
   \ead{mikes@unimelb.edu.au} 
    \author[University of Melbourne]{Dylan McConnell\corref{2}}
   \ead{bob@example.com} 
      \address[University of Melbourne]{School of Earth Sciences, University of Melbourne, VIC, 3010}
    \address[University of Melbourne]{School of Earth Sciences, University of Melbourne, VIC, 3010}
      \cortext[1]{Corresponding Author}
    \cortext[2]{Equal contribution}
  
  \begin{abstract}
  Gas production aocrss eastern Australia incresed by \textasciitilde{}
  300\% across the years 2014-2019, in response to opening of new coal
  seam gas (CSG) fields in Queensland.
  \end{abstract}
