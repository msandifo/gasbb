...
source('~/Dropbox/msandifo/documents/programming/r/2020/gasbb/r/read_flows.R')
...
#  
#
 af.reorder <-tidyr::pivot_wider(archived.flows, names_from =flowdirection,   values_from = actualquantity,
                                 values_fill=list(DELIVERY=0, RECEIPT=0) )%>%
